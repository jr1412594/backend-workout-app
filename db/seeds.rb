...
w8 = Workout.create(name: "Side Lateral Raise", kind: "Shoulders", description: "Exercise the medial or middle deltoid", video: "https://www.youtube.com/embed/LT1Eo-q58yg", image: "https://images.unsplash.com/photo-1581009137042-c552e485697a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
w9 = Workout.create(name: "Hammer Curls", kind: "Arms", description: "Target the long head of the Biceps", video: "https://www.youtube.com/embed/0IAM2YtviQY", image: "https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60")
w10 = Workout.create(name: "Bent Over Barbell Row", kind: "Back", description: "Increase strength in your back; stimulates your lats, traps, and rhomboids", video: "https://www.youtube.com/embed/-xlBxIMqh3A", image: "https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60")
w11 = Workout.create(name: "Decline Dumbbell Bench Press", kind: "Chest", description: "Strengthen you lower chest muscles.", video: "https://www.youtube.com/embed/Pf1nDoqx_1A", image: "https://images.unsplash.com/photo-1585152968992-d2b9444408cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60")
w12 = Workout.create(name: "Crunches", kind: "Core", description: "Helps ssthrengthen core by isolating you abdominal muscles", video: "https://www.youtube.com/embed/YdZakh0Pkwc", image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60")
