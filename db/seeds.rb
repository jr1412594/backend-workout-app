...
u1 = User.create(username: "Terminator", name: "Arnold Schwarzenegger", weight: 250.6, activity_level: 8, goal: "More muscle", age: 60, password_digest: "password")
u2 = User.create(username: "Therock", name: "Dwayne Johnson", weight: 230.4, activity_level: 10, goal: "Eat rocks", age: 52, password_digest: "password")
u3 = User.create(username: "Blist", name: "Tom Arnold", weight: 230.2, activity_level: 2, goal: "Get fit", age: 51, password_digest: "password")
